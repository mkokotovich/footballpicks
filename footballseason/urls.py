...
urlpatterns = [
    ...
    re_path(r'^records/(?P<season_id>[0-9]+)/$', views.records, {'week':0, 'view':'season'}, name='records_by_season'),

    # eg: /footballseason/records/2015/3/
    re_path(r'^records/(?P<season_id>[0-9]+)/(?P<week>[0-9]+)/$', views.records, {'view':'week'}, name='records_by_week'),

    # eg: /footballseason/records/2015/month/9/
    re_path(r'^records/(?P<season_id>[0-9]+)/month/(?P<month>[0-9]+)/$', views.records, {'view':'month'}, name='records_by_month'),
